...
export class OrdersComponent implements OnInit {
  ...
  //shippingInfoo : {city:string,apart:string,phone:number,street:string}[]=[];
  totalSales = 0;
  constructor(public orderService:OrderService,private snackBar:MatSnackBar){}
 ...
 ngOnInit() : void{
    this.orderService.getAllOrders().subscribe(data =>{
      ...
      //this.orderService.setTotalSales(this.totalSales)
      // this.orderService.SetTotalSales(this.totalSales)
